...
bool Consensus::CheckTxInputs(const CTransaction& tx, CValidationState& state, const CCoinsViewCache& inputs, const CEnhancedCSView * mnview, int nSpendHeight, CAmount& txfee)
{
