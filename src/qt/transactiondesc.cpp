...
QString TransactionDesc::toHTML(interfaces::Node& node, interfaces::Wallet& wallet, TransactionRecord *rec, int unit)
{
    ...
    else if (nNet > 0)
    {
        ...
        // Credit
        //
        strHTML += "<b>" + tr("Credit") + ":</b> " + DefiUnits::formatHtmlWithUnit(unit, nNet) + "<br>";
    }
    else
    {
        ...
        if (fAllFromMe)
        {
            ...
            for (const CTxOut& txout : wtx.tx->vout)
            {
                ...
                strHTML += "<b>" + tr("Debit") + ":</b> " + DefiUnits::formatHtmlWithUnit(unit, -txout.nValue) + "<br>";
                if(toSelf)
                    strHTML += "<b>" + tr("Credit") + ":</b> " + DefiUnits::formatHtmlWithUnit(unit, txout.nValue) + "<br>";
            }
    ...
    strHTML += "<b>" + tr("Net amount") + ":</b> " + DefiUnits::formatHtmlWithUnit(unit, nNet, true) + "<br>";
    ...
    // Message from normal defi:URI (defi:123...?message=example)
            ...
            {
                {
                    ...
                    strHTML = strHTML + " " + tr("Amount") + "=" + DefiUnits::formatHtmlWithUnit(unit, vout.nValue);
